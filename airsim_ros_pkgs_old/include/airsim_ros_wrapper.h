...
class AirsimROSWrapper {
 ...
 private:
  ...
  // void drone_state_timer_cb(const ros::SteadyTimerEvent& event); // update
  // drone state from airsim_client_ every nth sec
  ...
  void append_static_lidar_tf(VehicleROS* vehicle_ros,
  ...
  nav_msgs::Odometry get_odom_msg_from_truth_state(
  ...
  airsim_ros_pkgs::CarState get_roscarstate_msg_from_car_state(
      const msr::airlib::CarApiBase::CarState& car_state) const;
  msr::airlib::Pose get_airlib_pose(
  ...
  sensor_msgs::NavSatFix get_gps_msg_from_airsim(
